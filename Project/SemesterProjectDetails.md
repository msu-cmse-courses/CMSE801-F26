# CMSE 801 - Semester Project

As part of your semester in CMSE 801, you are expected to complete a fully-fledged data analysis or computational modeling project. This is your opportunity to choose a topic that sounds interesting to you and dig into it.

At the end of the semester you'll submit your work as a **detailed** Jupyter Notebook as well as presenting your findings to the rest of the class.
...
* Data Science: analyzing, modeling, and visualizing data, which can include:
...
* Computational methods that seek to answer your question. (This will vary from project to project, depending on the context).
...
You'll need to spend some time figuring out what model is the right model to use or what data are available to answer your question. The internet is your friend for this part. You should be able to find the details you need to compute your model or the data you want to analyze on the web. While the hope is that you have access to a dataset that is directly related to your chosen field, you also have the friend to pursue a topic outside of your discipline. These are some possible, non-exhaustive resources for locating data:
...
* **March 1/2**: Introduction to project. Project Plan Check-in assigned.

* **March 19/20**: Project Plan Check-in Due

* **April 16/17**: Draft of Semester Project Due; *You will submit a preliminary draft of your project notebook, along with 1-2 slides explaining your project and highlighting your work/results so far.*

* **April 17/18**: Structured Project Work Day 1; *All students will give *lightning presentations*, where everyone will give a short (<90 second, 2 slides max) presentation of their project in class. They will receive feedback from their classmates about their project.*

* **April 19/20**: Structured Project Work Day 2

* **April 23/24**: Semester Project Due

* **April 24 through 27**: Semester Project Presentations 
